...
<div class="container-fluid" style="margin-top: 3%; margin-bottom: 6%;">
    ...
    <div class="card">
        <div class="card-header">
          <h2 style="color: #e66767">Edit Permission For Role</h2>
        </div>
        <div class="card-body">
            <form method="POST" action="/dapur/super/permission/{!!$role->id!!}/update">
                {{ csrf_field() }}
                        ...
                        <div class="col-md-12">
                            <table class="table table-sm">
                                <thead class="borderless">
                                  <tr class="text-center" style="background-color: #fab0af">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" style="float: right; margin-top: 20px;">
                                <input class="btn" style="background-color: #e66767; color:#fff" type="submit" value="Update">
                            </div>
                        </div>
                    </div>
                </div>
